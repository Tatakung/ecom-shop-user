              ...
              >
                ...
                <div className="d-grid gap-3 mt-auto">
                  ...
                  <button
                    ...
                    style={{
                      borderRadius: "10px",
                      backgroundColor: "#333333", // สีปุ่มหลัก เทาเข้ม
                    ...
                    onMouseOver={(e) => {
                      if (!addingToCart && product.quantity > 0 && count > 0) {
                        // เพิ่มเงื่อนไข count > 0
                        e.target.style.transform = "translateY(-2px)";
                        e.target.style.boxShadow =
                          "0 8px 25px rgba(0, 0, 0, 0.2)"; // เงาอ่อนๆ
                        e.target.style.backgroundColor = "#555555"; // สีเทาเข้มขึ้นเมื่อโฮเวอร์
                      }
                    }}
                    onMouseOut={(e) => {
                  ...
                  <button
                    className="btn btn-lg fw-semibold d-flex align-items-center justify-content-center"
                    disabled={product.quantity <= 0 || count === 0} // ปิดการใช้งานถ้าสินค้าหมดหรือจำนวนเป็น 0
                    style={{
                      borderRadius: "10px",
                      backgroundColor: "transparent",
                      color: "#333333", // สีตัวอักษรเป็นสีเทาเข้ม
                      border: "1px solid #CCCCCC", // เส้นขอบสีเทาอ่อน
                      padding: "12px 0",
                      transition: "all 0.3s ease",
                    }}
                    onMouseOver={(e) => {
                      if (product.quantity > 0 && count > 0) {
                        // เพิ่มเงื่อนไข count > 0
                        e.target.style.backgroundColor = "#f2f2f2"; // เปลี่ยนเป็นเทาอ่อนเมื่อโฮเวอร์ (#f2f2f2)
